...
htmlFiles.forEach(file => {
    ...
    <footer class="site-footer reveal">
        <div class="container">
            <div class="site-footer__row-top" style="display: flex; justify-content: space-between; align-items: flex-start; padding: var(--space-xl) 0; flex-wrap: wrap; gap: var(--space-xl);">
            ...
            <div class="section-heading" style="margin: var(--space-lg) 0; width: 100%;">
                <div class="section-heading__line" style="flex: 1;"></div>
            </div>

            <div class="site-footer__row-bottom" style="text-align: center; padding-bottom: var(--space-xl);">
