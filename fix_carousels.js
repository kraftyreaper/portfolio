...
function updateFile(filename, replacementTrack, roleContent = null, teamContent = null) {
    let content = fs.readFileSync(filename, 'utf-8');

    // Replace carousel track
    const pattern = /(<div class="case-carousel__track">)(.*?)(<\/div>\s*<button class="case-carousel__btn case-carousel__btn--prev")/gs;
    content = content.replace(pattern, `$1\n${replacementTrack}\n                    $3`);

    // Replace role content if provided
    if (roleContent) {
        const rolePattern = /(<h3 class="role-team__heading">My Role<\/h3>\s*<p class="role-team__description">).*?(<\/p>)/gs;
        content = content.replace(rolePattern, `$1${roleContent}$2`);
    }

    // Replace team content if provided
    if (teamContent) {
        const teamPattern = /(<h3 class="role-team__heading">My Team<\/h3>\s*)(<p class="role-team__description">.*?<\/p>|<div class="role-team__list">.*?<\/div>)/gs;

        let teamHtml = '<div class="role-team__list">\n';
        for (const member of teamContent) {
            teamHtml += `                        <span class="role-team__member">${member}</span>\n`;
        }
        teamHtml += '                    </div>';

        content = content.replace(teamPattern, `$1${teamHtml}`);
    }

    fs.writeFileSync(filename, content, 'utf-8');
}

const homesCarousel = `                        <!-- 1. Research and discovery -->
                        ...
                        <div class="case-carousel__slide">
                            <div class="case-carousel__slide-content" style="text-align: left;">
                                ...
                                <ul style="list-style-position: inside; padding-left: 0; color: var(--text-secondary); line-height: 1.6; font-size: var(--font-size-md);">
                                    <li>Structuring all the documented data into web pages, ensuring accessibility through placements of the information at right place which helps the user achieve their goals at different touch points</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="case-carousel__slide">
                            <div class="case-carousel__slide-content" style="text-align: left;">
                                ...
                                <ul style="list-style-position: inside; padding-left: 0; color: var(--text-secondary); line-height: 1.6; font-size: var(--font-size-md);">
                                    <li>Created the foundation of the design language to scale across web designs with uniformity and consistency. Created the design elements and converting them into components to facilitate effective work processes</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="case-carousel__slide">
                            <div class="case-carousel__slide-content" style="text-align: left;">
                                ...
                                <ul style="list-style-position: inside; padding-left: 0; color: var(--text-secondary); line-height: 1.6; font-size: var(--font-size-md);">
                                    <li>Created high-fidelity design screens to enhance communication visually and elevate the brand's understanding using retentive brand elements. We also implemented a unique visual direction to bring in the premium look and feel of the business to create an aspirational value for the potential users of the properties.</li>
                                </ul>
                            </div>
                        </div>
...
const grayCarousel = `                        <!-- 1. Research and Discovery -->
                        <div class="case-carousel__slide">
                            <div class="case-carousel__slide-content" style="text-align: left;">
                                <h3 class="case-carousel__title" style="text-align: left; border-bottom: 1px solid var(--border-subtle); padding-bottom: var(--space-sm); margin-bottom: var(--space-md);">1. Research and Discovery</h3>
                                <ul style="list-style-position: inside; padding-left: 0; color: var(--text-secondary); line-height: 1.6; font-size: var(--font-size-md);">
...
const milestoneCarousel = `                        <!-- 1. Discovery and Planning -->
                        <div class="case-carousel__slide">
                            <div class="case-carousel__slide-content" style="text-align: left;">
...
const asviCarousel = `                        <!-- 1. Branding - Onboarding questionnaires -->
                        <div class="case-carousel__slide">
                            <div class="case-carousel__slide-content" style="text-align: left;">
...
updateFile("case-studies/asvi-thoughtworks.html", asviCarousel, asviRole, asviTeam);

updateFile("case-studies/gray-institute.html", grayCarousel);
